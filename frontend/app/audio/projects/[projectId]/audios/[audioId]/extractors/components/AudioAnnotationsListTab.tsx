...
import { AudioAnnotationsListTable } from '../../../../../../components/AudioAnnotationsListTable'

interface AudioAnnotationsListTabProps {
...
export function AudioAnnotationsListTab({
